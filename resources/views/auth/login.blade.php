...
@section('content')
        <div class="container">
            <div class="loginbox">
                <div class="login-left"> <img class="img-fluid" src="https://upload.wikimedia.org/wikipedia/commons/2/27/Lambang_Kabupaten_Lampung_Selatan.png" alt="Logo"> </div>
                <div class="login-right">
                    <div class="login-right-wrap">
                        <h1>Login</h1>
                        <p class="account-subtitle">Sistem Pendukung Keputusan Rekomendasi Bansos PKH Menggunakan Simple Addictive Weighting (SAW)</p>
                        <form method="POST" action="{{ route('login') }}">
                            @csrf
